...
ENV_VAR_MAPPING_SNAPSHOT = (
    {'DEFAULT_MODEL': 'WHISPER_DEFAULT_MODEL',
     ...
     'STATS_OWN_SHOWS_MACHINE': 'WHISPER_STATS_OWN_SHOWS_MACHINE',
     'STATS_HISTORY_SAMPLE_S': 'WHISPER_STATS_HISTORY_SAMPLE_S',
     'STATS_HISTORY_RETENTION_DAYS': 'WHISPER_STATS_HISTORY_RETENTION_DAYS'}
)
